...
CAPABILITY_DESCRIPTIONS = {
    ...
    "spillFormula": "Write a dynamic array formula (FILTER, SORT, UNIQUE, SEQUENCE, RANDARRAY) that spills automatically. Params: cell (single cell), formula (e.g. '=FILTER(A:C,B:B>100)'), sheetName (optional).",
}
